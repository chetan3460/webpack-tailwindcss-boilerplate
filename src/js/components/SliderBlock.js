...
export default class SliderBlock {
    ...
    initSliders() {
        ...
        carousels.forEach((slider1, i) => {
            ...
            const sliderAutoPlayTime = Number(slider1.getAttribute('data-autoplaytime')) || 5000;
            const sliderAutoHeight = slider1.getAttribute('data-autoheight') === 'true';
            const sliderResizeUpdate = slider1.getAttribute('data-resizeupdate') !== 'false';
            const sliderAllowTouchMove = slider1.getAttribute('data-drag') !== 'false';
            const sliderReverseDirection = slider1.getAttribute('data-reverse') === 'true';
            const sliderMargin = Number(slider1.getAttribute('data-margin')) || 30;
            const sliderLoop = slider1.getAttribute('data-loop') === 'true';
